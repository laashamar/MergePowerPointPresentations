"""Main graphical user interface for the PowerPoint Merger application.

This module defines the GUI components using PySide6 framework. It provides
an intuitive interface for managing and merging PowerPoint presentations with
features including file selection, reordering, and progress tracking.
"""
...
class MainWindow(QMainWindow):
    ...
    - Add and remove PowerPoint files
    - Reorder files for merging
    - Merge files with progress tracking
    - View and manage the file list
    """
        ...
        if output_path:
            ...
            try:
                ...
                QMessageBox.information(
                    self, "Success", f"Successfully merged files to {output_path}"
                )
